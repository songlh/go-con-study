...
func waitDeleteBug(ctx context.Context, client *v3.Client, key string, rev int64) error {
...
func waitDeletesBug(ctx context.Context, client *v3.Client, key string, opts ...v3.OpOption) error {
	...
	for err == nil {
		...
		err = waitDeleteBug(ctx, client, string(lastKV.Key), maxRev)
